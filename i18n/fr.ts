export default {
    ...
    menu_my_pets: "Mes Animaux",
    
    // Pets
    pets_title: "Mes Animaux",
    pets_add: "Ajouter un Animal",
    pets_edit: "Modifier l'Animal",
    pets_empty_title: "Aucun Animal Ajouté",
    pets_empty_sub: "Ajoutez vos animaux pour que les hôtes sachent de qui ils s'occuperont !",
    pets_form_name: "Nom *",
    pets_form_name_ph: "ex. Max",
    pets_form_type: "Type d'Animal *",
    pets_form_type_dog: "Chien",
    pets_form_type_cat: "Chat",
    pets_form_type_exotic: "Exotique/Autre",
    pets_form_breed: "Race *",
    pets_form_breed_ph: "ex. Golden Retriever",
    pets_form_age: "Âge *",
    pets_form_age_ph: "ex. 3 ans",
    pets_form_weight: "Poids (kg) *",
    pets_form_weight_ph: "ex. 15",
    pets_form_medical: "Conditions Médicales *",
    pets_form_medical_ph: "Écrivez 'Aucune' si en parfaite santé. Sinon décrivez allergies, médicaments, etc.",
    pets_form_temperament: "Tempérament (Optionnel)",
    pets_form_temperament_ph: "ex. Amical avec les enfants, timide avec les autres chiens",
    pets_form_save: "Enregistrer le Profil",
    pets_form_delete: "Supprimer l'Animal",
    pets_form_delete_title: "Supprimer",
    pets_form_delete_msg: "Êtes-vous sûr de vouloir supprimer ce profil d'animal ?",
    pets_form_missing: "Champs Manquants",
    pets_form_missing_msg: "Veuillez remplir tous les champs obligatoires (Nom, Race, Âge, Poids, Conditions).",
    pets_form_error: "Erreur",
    pets_form_error_save: "Échec de l'enregistrement du profil.",
    pets_form_error_not_found: "Animal non trouvé",
    pets_form_cancel: "Annuler",
    ...
    host_setup_price: "Tarif de base par nuit (MAD)",
    ...
    booking_session_rate: "Tarif par session ({{price}} MAD)",
    ...
    host_form_price: "Tarif par nuit / session (MAD)",
