export default {
    ...
    menu_my_pets: "My Pets",
    
    // Pets
    pets_title: "My Pets",
    pets_add: "Add Pet",
    pets_edit: "Edit Pet",
    pets_empty_title: "No Pets Added Yet",
    pets_empty_sub: "Add your pets so hosts know who they'll be taking care of!",
    pets_form_name: "Name *",
    pets_form_name_ph: "e.g. Max",
    pets_form_type: "Pet Type *",
    pets_form_type_dog: "Dog",
    pets_form_type_cat: "Cat",
    pets_form_type_exotic: "Exotic/Other",
    pets_form_breed: "Breed *",
    pets_form_breed_ph: "e.g. Golden Retriever",
    pets_form_age: "Age *",
    pets_form_age_ph: "e.g. 3 years",
    pets_form_weight: "Weight (kg) *",
    pets_form_weight_ph: "e.g. 15",
    pets_form_medical: "Medical Conditions *",
    pets_form_medical_ph: "Write 'None' if perfectly healthy. Otherwise describe allergies, medications, etc.",
    pets_form_temperament: "Temperament (Optional)",
    pets_form_temperament_ph: "e.g. Friendly with kids, shy around other dogs",
    pets_form_save: "Save Pet Profile",
    pets_form_delete: "Delete Pet",
    pets_form_delete_title: "Delete Pet",
    pets_form_delete_msg: "Are you sure you want to remove this pet profile?",
    pets_form_missing: "Missing Fields",
    pets_form_missing_msg: "Please fill in all mandatory fields (Name, Breed, Age, Weight, Medical Conditions).",
    pets_form_error: "Error",
    pets_form_error_save: "Failed to save pet profile.",
    pets_form_error_not_found: "Pet not found",
    pets_form_cancel: "Cancel",
    ...
    host_setup_price: "Base Nightly Rate (MAD)",
    ...
    booking_session_rate: "Session Rate ({{price}} MAD)",
    ...
    host_form_price: "Nightly / Session Rate (MAD)",
